...
const WelcomeModal = ({ onClose }) => {
    return (
        <div className="fixed inset-0 bg-indigo-900/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-in fade-in duration-300">
            <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden">
                <div className="bg-indigo-600 p-6 text-center">
                    <div className="bg-white/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-md">
                        <Sparkles className="text-white h-8 w-8" />
                    </div>
                    <h2 className="text-2xl font-extrabold text-white">Welcome to HausKey!</h2>
                    <p className="text-indigo-100 text-sm mt-1">Your home's digital pedigree starts here.</p>
                </div>
                <div className="p-8 space-y-6">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900">Secure Your History</h3>
                            <p className="text-gray-500 text-sm leading-relaxed">Stop losing receipts. Log repairs, upgrades, and paint colors permanently.</p>
                        </div>
                    </div>
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900">Automated Maintenance</h3>
                            <p className="text-gray-500 text-sm leading-relaxed">Get smart reminders for filters, flushing heaters, and more.</p>
                        </div>
                    </div>
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900">Increase Home Value</h3>
                            <p className="text-gray-500 text-sm leading-relaxed">Generate a professional <strong>Pedigree Report</strong> when you're ready to sell.</p>
                        </div>
                    </div>
                    
                    <button 
                        onClick={onClose}
                        className="w-full py-3.5 bg-indigo-600 text-white font-bold rounded-xl shadow-lg hover:bg-indigo-700 hover:scale-[1.02] transition-all transform"
                    >
                        Let's Get Started
                    </button>
                </div>
...
const AppContent = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 sm:p-8 font-sans relative">
             {/* ... Header ... */}
