...
const ContractorView = () => {
    ...
    useEffect(() => {
        ...
        const fetchRequest = async () => {
            try {
                // If the user is already logged in, that's fine. 
                ...
                if (!auth.currentUser) {
                    try {
                        ...
                        if (e.code === 'auth/admin-restricted-operation') {
                            console.warn("Anonymous auth is disabled in Firebase Console. Contractor view requires public access or anon auth enabled.");
                            // Fallback: Try to fetch anyway. If security rules allow public read for requests, it will work.
                            // If not, it will fail at the getDoc step below.
                        } else {
                            throw e;
                        }
                    }
