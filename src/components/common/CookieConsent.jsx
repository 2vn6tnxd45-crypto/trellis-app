...
export const CookieConsent = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-[100] flex flex-col sm:flex-row items-center justify-between gap-4 animate-in slide-in-from-bottom-4">
            <div className="text-sm text-slate-600">
                <p className="font-bold text-slate-800">We value your privacy</p>
                <p>We use data to find you relevant home discounts and maintenance offers. We do not sell your personal info.</p>
            </div>
